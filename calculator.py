...
class Calculator():
    def __init__(self):
        ...
        self.logAreaMessage = Message(self.logArea, width = 305, textvariable = self.log, bg = '#1f1e24', fg = '#363336', font = ('Consolas',12,'bold'))
        ...
        self.displayAreaMessage = Message(self.displayArea, width = 300, textvariable = self.val, bg = '#1f1e24', fg = '#f0ebf0', font = ('Consolas',28,'bold'))
        ...
        btnPercent = Button(self.btn, text = '%', bg = '#363336', fg = '#f0ebf0', font = ('Consolas',12), command = lambda:self.display('%'))
        btnPercent.place(x = 5, y = 28, width = 75.25, height = 50)
        btnPercent['relief'] = 'flat'
        btnCE = Button(self.btn, text = 'CE', bg = '#363336', fg = '#f0ebf0', font = ('Consolas',12), command = lambda:self.display('CE'))
        btnCE.place(x = 83.25, y = 28, width = 75.25, height = 50)
        btnCE['relief'] = 'flat'
        btnC = Button(self.btn, text = 'C', bg = '#363336', fg = '#f0ebf0', font = ('Consolas',12), command = lambda:self.reset())
        btnC.place(x = 161.5, y = 28, width = 75.25, height = 50)
        btnC['relief'] = 'flat'
        btnDel = Button(self.btn, text = '⌫', bg = '#363336', fg = '#f0ebf0', font = ('Consolas',12), command = lambda:self.display('<'))
        btnDel.place(x = 239.75, y = 28, width = 75.25, height = 50)
        btnDel['relief'] = 'flat'
        
        btnFr = Button(self.btn, text = '1/x', bg = '#363336', fg = '#f0ebf0', font = ('Consolas',12), command = lambda:self.display('1/x'))
        btnFr.place(x = 5, y = 81, width = 75.25, height = 50)
        btnFr['relief'] = 'flat'
        btnSq = Button(self.btn, text = 'x2', bg = '#363336', fg = '#f0ebf0', font = ('Consolas',12), command = lambda:self.display('*2'))
        btnSq.place(x = 83.25, y = 81, width = 75.25, height = 50)
        btnSq['relief'] = 'flat'
        btnSr = Button(self.btn, text = '2√x', bg = '#363336', fg = '#f0ebf0', font = ('Consolas',12), command = lambda:self.display('√'))
        ...
        btnNeg = Button(self.btn, text = '+/-', bg = '#473d47', fg = '#f0ebf0', font = ('Consolas',12), command = lambda:self.display('-'))
    ...
    def displayHistory(self):
        ...
        self.historyLog = Message(self.historyLabel, text = '', bg = '#1f1e24', fg = '#363336', font = ('Consolas',12,'bold'), width = 200)
